"""
Django settings for awesomepose project.
...
SECRET_KEY = '$&eap3fqji@d+ep-vswtfp*vjd__s^bvv7j75pt%0pl6*dfhtq'
...
WSGI_APPLICATION = 'awesomepose.wsgi.application'
